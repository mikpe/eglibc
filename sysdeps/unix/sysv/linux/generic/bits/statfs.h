...
struct statfs
  {
    ...
    __field64(__fsblkcnt_t, __fsblkcnt64_t, f_blocks, 0);
    __field64(__fsblkcnt_t, __fsblkcnt64_t, f_bfree, 1);
    __field64(__fsblkcnt_t, __fsblkcnt64_t, f_bavail, 2);
    __field64(__fsfilcnt_t, __fsfilcnt64_t, f_files, 3);
    __field64(__fsfilcnt_t, __fsfilcnt64_t, f_ffree, 4);
    __fsid_t f_fsid;
